...
**Ảnh**: mặc định bật "Kèm ảnh" — ảnh được tách ra file riêng và gói chung vào `.zip`,
markdown chỉ chứa link `![](tai-lieu_assets/docx_img001.png)`. **Không bao giờ nhúng
base64.** Bỏ tick nếu chỉ cần chữ.

Máy chủ chỉ lắng nghe ở `127.0.0.1` — không mở ra mạng LAN, không gọi ra Internet.
Giới hạn upload 200 MB mỗi lần.
